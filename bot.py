...
DEFAULT_ACTIONS = {
    ...
    "обнимаю": {"male": "обнимает {target}", "female": "обнимает {target}", "emoji": "🤗"},
    ...
    "береги": {"male": "просит {target} беречь себя", "female": "просит {target} беречь себя", "emoji": "🛡️"},
    ...
    "не могу": {"male": "не может без {target}", "female": "не может без {target}", "emoji": "💔"},
    "подожди": {"male": "просит {target} подождать", "female": "просит {target} подождать", "emoji": "⏳"},
    "вернись": {"male": "просит {target} вернуться", "female": "просит {target} вернуться", "emoji": "🔄"},
    "отстань": {"male": "просит {target} отстать", "female": "просит {target} отстать", "emoji": "🙅"},
    "помню": {"male": "помнит тот день с {target}", "female": "помнит тот день с {target}", "emoji": "📅"},
    ...
    "уважаю": {"male": "уважает {target}", "female": "уважает {target}", "emoji": "🤝"},
    "угомонись": {"male": "просит {target} угомониться", "female": "просит {target} угомониться", "emoji": "😌"},
    "голос": {"male": "голос {target} успокаивает", "female": "голос {target} успокаивает", "emoji": "🎵"},
    "зачем": {"male": "спросил {target}, зачем он это сделал", "female": "спросила {target}, зачем он это сделал", "emoji": "🤔"},
    "горжусь": {"male": "гордится {target}", "female": "гордится {target}", "emoji": "🏆"},
    "дай время": {"male": "просит {target} дать время", "female": "просит {target} дать время", "emoji": "⏰"},
    "прощу": {"male": "всё простит {target}", "female": "всё простит {target}", "emoji": "🕊️"},
    "завязывай": {"male": "сказал {target} завязывать", "female": "сказала {target} завязывать", "emoji": "✂️"},
    "прав": {"male": "сказал, что {target} всегда прав", "female": "сказала, что {target} всегда права", "emoji": "✅"},
    "не лезь": {"male": "просит {target} не лезть", "female": "просит {target} не лезть", "emoji": "🚧"},
    "доверяю": {"male": "доверяет {target}", "female": "доверяет {target}", "emoji": "🤝"},
    ...
    "поверь": {"male": "просит {target} поверить", "female": "просит {target} поверить", "emoji": "🤞"},
    "прости": {"male": "извинился перед {target}", "female": "извинилась перед {target}", "emoji": "🙇"},
    "ты прав": {"male": "сказал, что {target} прав", "female": "сказала, что {target} права", "emoji": "👍"},
    "нужен": {"male": "нужен {target}", "female": "нужен {target}", "emoji": "💫"},
    "теряюсь": {"male": "теряется рядом с {target}", "female": "теряется рядом с {target}", "emoji": "😵"},
    "знаю": {"male": "знает, что чувствует {target}", "female": "знает, что чувствует {target}", "emoji": "🧠"},
    "думаю": {"male": "думает о {target}", "female": "думает о {target}", "emoji": "💭"},
    "справимся": {"male": "сказал, что они справятся с {target}", "female": "сказала, что они справятся с {target}", "emoji": "💪"},
    "хочу рядом": {"male": "хочет быть рядом с {target}", "female": "хочет быть рядом с {target}", "emoji": "🏠"},
    "получится": {"male": "сказал, что у {target} всё получится", "female": "сказала, что у {target} всё получится", "emoji": "🎯"},
    "спокойно": {"male": "спокойно с {target}", "female": "спокойно с {target}", "emoji": "😌"},
    "уверена": {"male": "уверен в {target}", "female": "уверена в {target}", "emoji": "✨"},
    "взять за руку": {"male": "взял за руку {target}", "female": "взяла за руку {target}", "emoji": "🤝"},
    "похлопать": {"male": "похлопал по плечу {target}", "female": "похлопала по плечу {target}", "emoji": "🫱"},
    "дать пять": {"male": "дал пять {target}", "female": "дала пять {target}", "emoji": "🙌"},
    "подмигнуть": {"male": "подмигнул {target}", "female": "подмигнула {target}", "emoji": "😉"},
    "комплимент": {"male": "сделал комплимент {target}", "female": "сделала комплимент {target}", "emoji": "🥰"},
    "воздушный поцелуй": {"male": "послал воздушный поцелуй {target}", "female": "послала воздушный поцелуй {target}", "emoji": "💋"},
    "прижаться": {"male": "прижался к {target}", "female": "прижалась к {target}", "emoji": "🫶"},
    "укутать": {"male": "укутал пледом {target}", "female": "укутала пледом {target}", "emoji": "🛌"},
    "угостить чаем": {"male": "угостил чаем {target}", "female": "угостила чаем {target}", "emoji": "☕️"},
    "поделиться сладостями": {"male": "поделился сладостями с {target}", "female": "поделилась сладостями с {target}", "emoji": "🍫"},
    "подарить подарок": {"male": "подарил подарок {target}", "female": "подарила подарок {target}", "emoji": "🎁"},
    "пригласить на свидание": {"male": "пригласил на свидание {target}", "female": "пригласила на свидание {target}", "emoji": "💌"},
    "признаться в любви": {"male": "признался в любви {target}", "female": "призналась в любви {target}", "emoji": "❤️"},
    "сделать предложение": {"male": "сделал предложение {target}", "female": "сделала предложение {target}", "emoji": "💎"},
    "расстаться": {"male": "расстался с {target}", "female": "рассталась с {target}", "emoji": "💔"},
    "развестись": {"male": "развелся с {target}", "female": "развелась с {target}", "emoji": "📄"},
    "подружиться": {"male": "подружился с {target}", "female": "подружилась с {target}", "emoji": "🤝🏻"},
    "помириться": {"male": "помирился с {target}", "female": "помирилась с {target}", "emoji": "🕊"},
    "поддержать": {"male": "поддержал {target}", "female": "поддержала {target}", "emoji": "💞"},
    "поблагодарить": {"male": "поблагодарил {target}", "female": "поблагодарила {target}", "emoji": "🙏"},
    "поклониться": {"male": "поклонился {target}", "female": "поклонилась {target}", "emoji": "🙇"},
    "поприветствовать": {"male": "поприветствовал {target}", "female": "поприветствовала {target}", "emoji": "👋"},
    "попрощаться": {"male": "попрощался с {target}", "female": "попрощалась с {target}", "emoji": "😔"},
    "рассмешить": {"male": "рассмешил {target}", "female": "рассмешила {target}", "emoji": "😹"},
    "напугать": {"male": "напугал {target}", "female": "напугала {target}", "emoji": "👻"},
    "пощекотать": {"male": "пощекотал {target} пёрышком", "female": "пощекотала {target} пёрышком", "emoji": "🪶"},
    "ткнуть": {"male": "ткнул {target}", "female": "ткнула {target}", "emoji": "👉"},
    "ущипнуть": {"male": "ущипнул {target}", "female": "ущипнула {target}", "emoji": "🤏"},
    "потрепать": {"male": "потрепал {target} за щёки", "female": "потрепала {target} за щёки", "emoji": "😊"},
    "взъерошить": {"male": "взъерошил волосы {target}", "female": "взъерошила волосы {target}", "emoji": "💇"},
    "показать язык": {"male": "показал язык {target}", "female": "показала язык {target}", "emoji": "😛"},
    "подразнить": {"male": "подразнил {target}", "female": "подразнила {target}", "emoji": "😜"},
    "кинуть подушкой": {"male": "кинул подушкой в {target}", "female": "кинула подушкой в {target}", "emoji": "🛏"},
    "облить водой": {"male": "облил водой {target}", "female": "облила водой {target}", "emoji": "💦"},
    "накормить": {"male": "накормил {target}", "female": "накормила {target}", "emoji": "🍰"},
    "украсть еду": {"male": "украл еду у {target}", "female": "украла еду у {target}", "emoji": "🍪"},
    "заснуть на плече": {"male": "заснул на плече {target}", "female": "заснула на плече {target}", "emoji": "😴"},
    "положить голову": {"male": "положил голову на плечо {target}", "female": "положила голову на плечо {target}", "emoji": "🥹"},
    "покружить": {"male": "покружил на руках {target}", "female": "покружила на руках {target}", "emoji": "🌀"},
    "поднять на руки": {"male": "поднял на руки {target}", "female": "подняла на руки {target}", "emoji": "👐"},
    "толкнуть": {"male": "толкнул {target}", "female": "толкнула {target}", "emoji": "🫸"},
    "пнуть": {"male": "пнул {target}", "female": "пнула {target}", "emoji": "🦵"},
    "дать пощёчину": {"male": "дал пощёчину {target}", "female": "дала пощёчину {target}", "emoji": "👋"},
    "бросить снежок": {"male": "бросил снежок в {target}", "female": "бросила снежок в {target}", "emoji": "☃️"},
    "вызвать на дуэль": {"male": "вызвал на дуэль {target}", "female": "вызвала на дуэль {target}", "emoji": "⚔️"},
    "защитить": {"male": "защитил {target}", "female": "защитила {target}", "emoji": "🛡"},
    "связать": {"male": "связал {target}", "female": "связала {target}", "emoji": "🪢"},
    "арестовать": {"male": "арестовал {target}", "female": "арестовала {target}", "emoji": "🚓"},
    "ограбить": {"male": "ограбил {target}", "female": "ограбила {target}", "emoji": "💰"},
    "проклясть": {"male": "проклял {target}", "female": "прокляла {target}", "emoji": "👿"},
    "благословить": {"male": "благословил {target}", "female": "благословила {target}", "emoji": "😇"},
    "исцелить": {"male": "исцелил {target}", "female": "исцелила {target}", "emoji": "❤️‍🩹"},
    "заморозить": {"male": "заморозил {target}", "female": "заморозила {target}", "emoji": "🧊"},
    "поджечь": {"male": "поджёг {target}", "female": "подожгла {target}", "emoji": "🔥"},
    "телепортировать": {"male": "телепортировал {target}", "female": "телепортировала {target}", "emoji": "🌀"},
    "превратить в кота": {"male": "превратил {target} в кота", "female": "превратила {target} в кота", "emoji": "🐈"},
    "кинуть заклинание": {"male": "кинул заклинание в {target}", "female": "кинула заклинание в {target}", "emoji": "🪄"},
    "покормить с рук": {"male": "покормил с рук {target}", "female": "покормила с рук {target}", "emoji": "🍓"},
    "выпить вместе": {"male": "выпил вместе с {target}", "female": "выпила вместе с {target}", "emoji": "🍻"},
    "посмотреть фильм": {"male": "посмотрел фильм вместе с {target}", "female": "посмотрела фильм вместе с {target}", "emoji": "🍿"},
    "позвать гулять": {"male": "позвал гулять {target}", "female": "позвала гулять {target}", "emoji": "🚶"},
    "сфотографироваться": {"male": "сфотографировался вместе с {target}", "female": "сфотографировалась вместе с {target}", "emoji": "📸"},
    "поиграть": {"male": "поиграл вместе с {target}", "female": "поиграла вместе с {target}", "emoji": "🎮"},
    "прошептать на ухо": {"male": "прошептал на ухо {target}", "female": "прошептала на ухо {target}", "emoji": "🤫"},
    "рассказать секрет": {"male": "рассказал секрет {target}", "female": "рассказала секрет {target}", "emoji": "🤐"},
    "засмущать": {"male": "засмущал {target}", "female": "засмущала {target}", "emoji": "😳"},
    "посмотреть с осуждением": {"male": "посмотрел с осуждением на {target}", "female": "посмотрела с осуждением на {target}", "emoji": "🧐"},
    "накричать": {"male": "накричал на {target}", "female": "накричала на {target}", "emoji": "😡"},
    "простить": {"male": "простил {target}", "female": "простила {target}", "emoji": "🕊"},
    "сделать сюрприз": {"male": "сделал сюрприз {target}", "female": "сделала сюрприз {target}", "emoji": "🎊"},
    "подарить питомца": {"male": "подарил питомца {target}", "female": "подарила питомца {target}", "emoji": "🐈"},
    "позвать на помощь": {"male": "позвал на помощь {target}", "female": "позвала на помощь {target}", "emoji": "🆘"},
    ...
    "чокнуться": {"male": "чокнулся бокалами с {target}", "female": "чокнулась бокалами с {target}", "emoji": "🥂"},
}
