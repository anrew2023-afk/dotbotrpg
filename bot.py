...
"ты прав": {
    "male": {"male": "сказал, что {target} прав", "female": "сказал, что {target} права"},
    "female": {"male": "сказала, что {target} прав", "female": "сказала, что {target} права"},
    "emoji": "👍"
},
"опора": {
...
"солнце": {
    "male": {"male": "назвал {target} своим солнцем", "female": "назвал {target} своим солнцем"},
    "female": {"male": "назвала {target} своим солнцем", "female": "назвала {target} своим солнцем"},
    "emoji": "☀️"
},
"оставь": {
...
"зачем": {
    "male": {"male": "спросил {target}, зачем он это сделал", "female": "спросил {target}, зачем она это сделала"},
    "female": {"male": "спросила {target}, зачем он это сделал", "female": "спросила {target}, зачем она это сделала"},
    "emoji": "🤔"
},
"получится": {
    "male": {"male": "сказал, что у {target} всё получится", "female": "сказал, что у {target} всё получится"},
    "female": {"male": "сказала, что у {target} всё получится", "female": "сказала, что у {target} всё получится"},
    "emoji": "🎯"
},
"справимся": {
    "male": {"male": "сказал, что они справятся с {target}", "female": "сказал, что они справятся с {target}"},
    "female": {"male": "сказала, что они справятся с {target}", "female": "сказала, что они справятся с {target}"},
    "emoji": "💪"
}
